...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php">
            <img src="img/whitelogo_wt-removebg.png" alt="logo" style=""> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link <?= isActive('browse.php', $currentPage) ?>" href="booksans/browse.php">Hotels</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= isActive('publiccontact.php', $currentPage) ?>" href="contact.php">Contact</a>
                </li>
            </ul>
