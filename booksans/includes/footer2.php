    ...
    <div class="container">
        <div class="footer-col logo-column">
            <div class="footer-logo">
                <img src="images/whitelogo_wt-removebg.png" alt="logo" style="width: 50px; height: 50px;">
            </div>
        ...
        <div class="footer-col social-contact-col">
            ...
            <a href="hotel_manager/register.php" class="hotel-partner-btn">Become Our Hotel Partner</a>
        </div>
    </div>
